        ...
        <main className="px-6 md:px-12 lg:px-20 space-y-24 md:space-y-40 mb-20 relative">
          ...
          <section id="hero" className="flex flex-col lg:flex-row gap-16 md:gap-8 items-center min-h-[70vh]">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 1 }} className="flex-1 space-y-8 relative z-10 w-full mb-10 lg:mb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-4 items-start sm:items-center relative">
                 ...
                 <a href="#contact" className="bg-[#66d9ef] border-[3px] border-black shadow-[5px_5px_0_0_#000] px-8 py-3 font-bold text-xl hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase tracking-tight text-center">
                   Contact Me
                 </a>
                 <button onClick={() => window.print()} className="bg-[#ffd93d] border-[3px] border-black shadow-[5px_5px_0_0_#000] px-8 py-3 font-bold text-xl hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase tracking-tight cursor-pointer text-center">
                   Download CV
                 </button>
              ...
              <div className="relative group perspective-1000 z-10 w-full flex justify-center cursor-pointer" onClick={() => {
                 ...
                 <div className="border-[5px] border-black bg-[#a8e6cf] shadow-[12px_12px_0_0_#000] w-[280px] h-[280px] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] rotate-[3deg] group-hover:rotate-0 transition-all duration-300 ease-in-out relative overflow-hidden p-2 flex items-center justify-center">
                    <img 
                      ...
                      className="w-[90%] h-[90%] object-contain drop-shadow-[5px_5px_0_rgba(0,0,0,1)] group-hover:scale-110 transition-transform duration-300"
                      onError={(e) => {
                        (e.target as HTMLImageElement).src = "https://ui-avatars.com/api/?name=Mohit+Boura&background=ffd93d&color=000&size=400&font-size=0.4&bold=true&border=2"
                      }}
                    />
                 </div>
          ...
          <section id="experience" className="relative space-y-16">
             ...
             <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
                ...
                {/* Map Section */}
                <div className="lg:col-span-3 border-[6px] border-black shadow-[12px_12px_0_0_#000] relative h-[400px] lg:h-[600px] z-10 bg-[#e0e0e0] overflow-hidden">
                  <div className="absolute -top-4 -right-4 bg-[#ff6b9d] text-white border-[3px] border-black shadow-[4px_4px_0_0_#000] px-4 py-2 font-black rotate-12 z-20">
                    Interactive Map
                  </div>
                    ...
                    {EXPERIENCES.map((exp, idx) => (
                      ...
                      >
                        <Popup className="brutalist-popup">
                          <div className="font-bold text-lg border-b-2 border-black pb-1 mb-2">{exp.company}</div>
                          <div className="text-sm font-semibold mb-1">{exp.title}</div>
                          <div className="text-xs opacity-80">{exp.locName}</div>
                        </Popup>
                      </Marker>
                    ))}
                ...
                <div className="w-full flex justify-center perspective-1000 z-20">
                    ...
                    >
                       <img 
                         ...
                         onError={(e) => {
                            (e.target as HTMLImageElement).src = "https://media.giphy.com/media/26n6WywJyh39n1pSp/giphy.gif"
                         }}
                       />
          ...
          <section id="hobbies" className="mt-12 mb-20">
             ...
             <div className="mt-12 flex flex-col lg:flex-row gap-12 items-center">
                ...
                <div className="grid sm:grid-cols-2 gap-6 w-full lg:w-2/3">
                   <div className="bg-[#fff2f8] border-[4px] border-black shadow-[8px_8px_0_0_#000] p-6 hover:-translate-y-2 transition-transform">
                      <Gamepad2 size={40} className="mb-4 text-[#ff6b9d]" />
                      <h4 className="text-2xl font-black mb-2">Esports & Gaming</h4>
                      <p className="font-medium">Playing and competing in esports, pushing strategies to the limit.</p>
                   </div>
                   <div className="bg-[#f2fbff] border-[4px] border-black shadow-[8px_8px_0_0_#000] p-6 hover:-translate-y-2 transition-transform">
                      <Tv size={40} className="mb-4 text-[#0077b5]" />
                      <h4 className="text-2xl font-black mb-2">Spectator</h4>
                      <p className="font-medium">Enjoying competitive streams, watching esports and cricket matches.</p>
                   </div>
                   <div className="bg-[#f3fff2] border-[4px] border-black shadow-[8px_8px_0_0_#000] p-6 hover:-translate-y-2 transition-transform">
                      <span className="text-4xl block mb-4">🏏</span>
                      <h4 className="text-2xl font-black mb-2">Cricket Lover</h4>
                      <p className="font-medium">Playing cricket in my free time to stay active, teamwork-oriented and sharp.</p>
                   </div>
                   <div className="bg-[#fffdf2] border-[4px] border-black shadow-[8px_8px_0_0_#000] p-6 hover:-translate-y-2 transition-transform">
                      <Cpu size={40} className="mb-4 text-[#ffd93d]" />
                      <h4 className="text-2xl font-black mb-2">Tech Explorer</h4>
                      <p className="font-medium">Deep diving and exploring new technologies and digital things.</p>
                   </div>
                </div>

                <div className="w-full lg:w-1/3 flex justify-center perspective-1000">
                    <div className="border-[5px] border-black bg-[#ff6b9d] shadow-[12px_12px_0_0_#000] w-[250px] h-[250px] md:w-[300px] md:h-[300px] rotate-[3deg] hover:rotate-0 transition-all duration-300 relative overflow-hidden flex items-center justify-center p-0">
                       <img 
                         src="https://media.giphy.com/media/26tn33aiTi1jIGsnu/giphy.gif" 
                         alt="Hobbies GIF" 
                         className="w-full h-full object-cover"
                         onError={(e) => {
                            (e.target as HTMLImageElement).src = "https://media.giphy.com/media/l41YkxvU8c7J7Bba0/giphy.gif"
                         }}
                       />
                       <div className="tape-sticker w-20 h-8 -top-4 right-4 rotate-[12deg] z-20"></div>
                    </div>
                </div>
